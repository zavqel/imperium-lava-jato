const IMPERIUM = {
  ...
  toleranceMinutes: 10,
  services: {
    economica: { id: 'economica', name: 'Lavagem Econômica', price: 75, minutes: null, group: 'Lavagem base', vehicle: 'carro-pequeno', desc: 'Lavagem base com valor atual para carros pequenos.' },
    basica: { id: 'basica', name: 'Lavagem Básica', price: 90, minutes: null, group: 'Lavagem base', vehicle: 'carro-pequeno', desc: 'Lavagem base com valor atual para carros pequenos.' },
    completa: { id: 'completa', name: 'Lavagem Completa', price: 100, minutes: null, group: 'Lavagem base', vehicle: 'carro-pequeno', desc: 'Lavagem base com valor atual para carros pequenos.' },
    descontaminacao: { id: 'descontaminacao', name: 'Descontaminação de pintura', price: 600, minutes: null, group: 'Estética', vehicle: 'qualquer', desc: 'A partir de R$ 600; duração a confirmar na avaliação.' },
    polimento: { id: 'polimento', name: 'Polimento', price: 600, minutes: null, group: 'Estética', vehicle: 'qualquer', desc: 'A partir de R$ 600; duração depende do veículo e da avaliação.' },
    bancos: { id: 'bancos', name: 'Higienização de bancos', price: 250, minutes: null, group: 'Higienização', vehicle: 'qualquer', desc: 'A partir de R$ 250.' },
    carpete: { id: 'carpete', name: 'Higienização de carpete', price: 200, minutes: null, group: 'Higienização', vehicle: 'qualquer', desc: 'A partir de R$ 200.' },
    teto: { id: 'teto', name: 'Higienização de teto', price: 150, minutes: null, group: 'Higienização', vehicle: 'qualquer', desc: 'A partir de R$ 150.' },
    plasticos: { id: 'plasticos', name: 'Partes plásticas / forros de porta', price: 150, minutes: null, group: 'Higienização', vehicle: 'qualquer', desc: 'A partir de R$ 150.' },
    chassi: { id: 'chassi', name: 'Lavagem de chassi', price: 150, minutes: null, group: 'Chassi', vehicle: 'qualquer', desc: 'A partir de R$ 150 para carros de uso urbano; sujeira intensa pode aumentar o valor.' },
    motor: { id: 'motor', name: 'Lavagem de motor', price: 0, minutes: null, group: 'Motor', vehicle: 'qualquer', desc: 'Valor por categoria; serviço mediante ciência dos riscos.' }
  },
  discounts: [
